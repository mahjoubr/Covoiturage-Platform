  ...
  const renderStars = () => {
    return Array(5).fill(0).map((_, idx) => (
      ...
      >
        <Star
          size={24}
          className={`${idx < stars ? "text-yellow-400" : "text-gray-300"} hover:text-yellow-300 transition-colors`}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none min-h-32"
          ...
          {error && (
            <div className="bg-red-50 rounded-lg p-3 mb-4 border-l-4 border-red-500">
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors font-medium flex items-center ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
            >
              {isSubmitting ? (
                <>
